...
let i = new lib.OpenXum.Abande.Intersection(s);
...
console.log("TEST INTERSECTION : GET COLOR : " + i.getColor());
i.setColor(col);
console.log("TEST INTERSECTION : SET COLOR : " + i.getColor());

console.log("TEST INTERSECTION : GET COORDINATE : " + i.getCoordinate().to_string());

console.log("TEST INTERSECTION : GET TAILLE PILLE : " + i.getTaillePile());
i.setTaillePile(2)
console.log("TEST INTERSECTION : SET TAILLE PILLE : " + i.getTaillePile());

i.taillePlus();
console.log("TEST INTERSECTION : TAILLE PILE PLUS : " + i.getTaillePile());

i.taillePileZero();
console.log("TEST INTERSECTION : TAILLE PILE ZERO : " + i.getTaillePile());
