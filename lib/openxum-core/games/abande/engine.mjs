...
class Engine extends OpenXum.Engine {
    ...
    _capture_piece(color,from,to) {
        ...
        {
            this._are_opposite_color(from,to);
        }
    ...
    {
        if(this._are_opposite_color(from,to) && this._are_neighbour(from,to) && this._no_hole(from,to) === true) {
            return true;
        }
        return false;
    }
    ...
    {
        let toHash = to.hash();
        let neighbour = this._get_neighboor(from);
