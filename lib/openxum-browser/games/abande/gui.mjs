...
class Gui extends OpenXum.Gui {
      ...
      if (this._engine.current_color() === this._color || this._gui !== null) {
        if (this._engine._intersections[i].getColor() === Abande.Color.DISPONIBLE && this._select === false) {
          ...
          this._move_type = Abande.Phase.CAPTURE_PIECE;
            ...
            if(this._engine._intersections[i].getColor()===Abande.Color.NONE || this._engine._intersections[i].getColor()===Abande.Color.DISPONIBLE  || (this._engine._intersections[i].getColor()===this._engine.current_color()))
            {
              this._select=false;
            }
            else
  ...
  _draw_score() {
    ...
    this._context.font = "20pt Calibri,Geneva,Arial";
    this._context.strokeStyle = "#CCCCCC";
    if(this._engine._count_score()[Abande.Color.BLACK]>9) {
      this._context.strokeText(this._engine._count_score()[Abande.Color.BLACK], (((1 * this._canvas.width / 14) - rayon / 1.25 )+10), ((7.5 * this._canvas.height / 8) + rayon / 2.5) + 10);
    }
    else
    {
      this._context.strokeText(this._engine._count_score()[Abande.Color.BLACK], (((1* this._canvas.width / 14) - rayon / 2.5 )+10), ((7.5 * this._canvas.height / 8) + rayon / 2) + 10);
    }
    this._context.stroke();
    ...
    this._context.font = "20pt Calibri,Geneva,Arial";
    this._context.strokeStyle = "#CCCCCC";
    if(this._engine._count_score()[Abande.Color.WHITE]>9) {
      this._context.strokeText(this._engine._count_score()[Abande.Color.WHITE], (((13 * this._canvas.width / 14) - rayon / 0.75 )+10), ((7.5 * this._canvas.height / 8) + rayon / 2.5) + 10);
    }
    else
    {
      this._context.strokeText(this._engine._count_score()[Abande.Color.WHITE], (((13 * this._canvas.width / 14) - rayon / 1.25 )+10), ((7.5 * this._canvas.height / 8) + rayon / 2.5) + 10);
    }
    this._context.stroke();
